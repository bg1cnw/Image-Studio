...
var fluentLight = fluentColors{
	...
	surfaceElevated: rgba(0xfbfbfb, 0xf5),
	sidebar:         rgba(0xf8f8f8, 0xd1),
	inspector:       rgba(0xf4f4f4, 0xd1),
	...
	cardGlow:        rgba(0xffffff, 0x1c),
	bgGlow:          rgba(0xffffff, 0x6b),
...
var fluentDark = fluentColors{
	...
	surfaceElevated: rgba(0x2b2b2b, 0xf5),
	...
	cardShadow:      rgba(0x000000, 0x57),
	cardGlow:        rgba(0xffffff, 0x08),
	bgGlow:          rgba(0xffffff, 0x0a),
